    ...
    return (
        <div>
            ...
            <div  className="container-fluid div-container rounded-main-box " bgColor="grey">
                ...
                <br/>
                <br/>
                <p className="text-center">Problematica<br/> <br/>
                     <br/>
                </p>
                <div className="justify-content-between d-flex align-items-center">
                    <p className="text-center">°Ineficaz control de inventario</p> <br/>
                    <p className="text-center">°Control y registro de ventas no eficiente <br/></p>
                    <p className=" text-center">°Mal manejo de registro de productos <br/>  </p>
                    <br/><br/>
                </div>
                <br/>
                <br/>
